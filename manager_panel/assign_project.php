                ...
                <form class="row g-3 ms-2 me-2" method="POST" id="projectForm" novalidate>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="employeeid" name="emp_id"
                            placeholder="Enter Employee-Id" oninput="fetchEmployeeDetails(this.value, true)">
                        <div class="error" id="emp_idError"></div>
                    </div>

                    <div class="col-md-6">
                        <label for="project_name" class="form-label">Employee Name</label>
                        <input type="text" class="form-control" id="employeename" name="emp_name"
                            placeholder="Enter Employee Name" oninput="fetchEmployeeDetails(this.value, false)">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="multiSelectDropdown">
                                ...
                                ?>
                                    <input type="checkbox" name="members[]"
                                        value="<?php echo $show['emp_id'] . '-' . $show['emp_name']; ?>">
                    ...
                    <div class="row md-6" style="padding-top:10px;">
                        <div class="col-md-4">
                            <label for="inputEmail4" class="form-label">Team Size</label>
                            <input type="number" class="form-control" id="inputEmail4" name="team_size"
                                value="<?php echo $result['team_size']; ?>">
                                <div class="error" id="team_sizeError"></div>
                        </div>

                        <div class="col-md-4">
                            <label for="team_size" class="">Create Meeting</label>
                            <input type="url" class="form-control custom-input" id="" name="links"
