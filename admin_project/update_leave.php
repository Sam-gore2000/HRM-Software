...
// Check if the user is logged in; you might need to modify this check based on your authentication logic
...
<div class="container ">
    ...
    <form method="POST" action="#">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="date" class="mb-2">From Date</label>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="date" class="mb-2">To Date</label>
