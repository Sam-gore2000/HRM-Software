...
<div class="container">
    <h2><b>Employee Attendance Form</b></h2>
    ...
    <form action="#" method="POST" id="attendanceform" enctype="multipart/form-data" novalidate>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="attendanceby" class="mb-2">Attendance-By</label>
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="checkin" class="mb-2">Check-in</label>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="checkout" class="mb-2">Check-out</label>
        ...
        <div class="form-group mb-3">
            <label for="position" class="mb-2">Status</label>
