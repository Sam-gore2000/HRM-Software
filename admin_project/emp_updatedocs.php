  ...
  <div class="container">
    ...
    <form action="#" method="POST" enctype="multipart/form-data" id="noticeForm" novalidate>
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
        <label for="event-description">Upload Your Adhar Card Image*</label>
        ...
        <div class="form-group col-md-6">
        <label for="event-description">Upload Your Pan Card Image*</label>
        ...
        <div class="form-group col-md-12 text-center"> <!-- Added text-center class here -->
          <button type="submit" class="btn btn-primary" name="submit">Update Docs</button>
        </div>
      </div>
