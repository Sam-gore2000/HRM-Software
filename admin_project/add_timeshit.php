            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="employeeid" class="mb-2">Add Timesheet</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="employeename" class="mb-2">Add Subject</label>
        ...
        <div class="container">
            ...
            <table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
                ...
                <!--<td>" . $result['id'] . "</td>-->
                  ...
                  <td>
                  <a href='delete_timeshit.php?id={$result['id']}' class='btn btn-danger text-white'>
