        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control"  placeholder="Phone Number"name="emp_mob1" id="mobileNumber1" value="<?php echo $show ['emp_mob1'] ?>"  required maxlength="10">
                </div>
                <div class="form-group col-md-6">
                    <label for="lastName">Phone Number</label>
                    <input type="number" class="form-control"  name="emp_mob2" placeholder="Phone Number" id="mobileNumber2"  value="<?php echo $show ['emp_mob2'] ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
