              ...
              <div class="col-md-6">
                                ...
                                <label>
                                    ...
                                    while ($show = mysqli_fetch_array($query_show)) {
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="members[]" value="<?php echo $concatenatedValue; ?>" <?php if (in_array($concatenatedValue, explode(', ', $result['members']))) echo 'checked'; ?>>
                ...
                <div class="row md-6" style="padding-top:10px;">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="inputEmail4" name="team_size" value="<?php echo $result['team_size']; ?>">
                    </div>
