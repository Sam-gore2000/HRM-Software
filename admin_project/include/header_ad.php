...
<style>
    ...
    .badge1 {
        ...
        padding: 0;
        background-color: #3BB77E;}
        /* Custom styles for Navbar and Slider */
    .navbar-brand {
        font-weight: bold;
    }
            ...
            <ul class="navbar-nav ml-auto" >
                ...
                <li class="nav-item">
                    <div class="form-check form-switch mt-2">
                        ...
                        <label class="form-check-label text-white" for="themeSwitch"><b>Theme </b></label>
                    </div>
                </li>
                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="layouts6">
                                <ul class="navbar-nav ps-3">
                                    <li>
                                        <a href="add_timesheet.php" class="nav-link text-white px-3">
                                            <span class="me-2"><i class="bi bi-plus"></i></span>
                                            <span>Add Link</span>
                                        </a>
                                    </li>
