      ...
      <div id="datetime" ></div>
        ...
        <div class="container-fluid  sam1">
            ...
            <div class="col-md-3 ">
                    ...
                    <img src="../images/project.gif" alt="Employee Image" class="card-image">
                    <?php
                           require 'db.php';
                ...
                <div class="col-md-3 ">
                    ...
                    <a href="task_view.php">
                        <div class="card-body py-2">
                        <img src="../images/task1.JPEG" alt="Employee Image" class="card-image">
                        <?php
                           require 'db.php';
                ...
                <div class="col-md-3 ">
                    ...
                    <a href="show_timeshit.php">
                        ...
                        <img src="../images/time.png" alt="Employee Image" class="card-image">
                        <?php
                           require 'db.php';
                ...
                <div class="col-md-3 ">
                    ...
                    <a href="emp_notice.php">
                        ...
                        <img src="../images/notice.jpg" alt="Employee Image" class="card-image">
                        <?php
                           require 'db.php';
